...
export function buildScreenshotEmbedBlock(
  ...
  return (
    ...
    `**'Adım:' etiketli görseller:** Bunlar tıklanacak öğenin YERİNİ kırmızı çerçeveyle işaretler. "X'e tıklayın" adımının hemen altına ÖNCE bu işaretli görseli, ardından tıklamanın SONUCUNU gösteren görseli (açılan modal vb.) embed et — okuyucu önce butonun yerini görür, sonra ne olacağını.\n\n` +
